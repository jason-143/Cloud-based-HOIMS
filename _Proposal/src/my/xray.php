...
<div class="main-body-holder">
    ...
    <?php 
            ...
            <div class="top-form-content">
                <div class="title">
                    <label id="my-account" for="top-form-title">X-ray</label><br><br>
            ...
            <form id="document-form-file" action="<?php echo rtrim($_SERVER['PHP_SELF'], 'function.php'); ?>" onsubmit="return showLoading();" method="post" enctype="multipart/form-data">
                ...
                <div class="user-information">
                    <div class="user user-username">
                        ...
                        <input maxlength="20" required class="in-put" type="text" name="clinic" placeholder="&#xf0f8; name" style="font-family:Arial, FontAwesome;">
                    </div>
                    <div class="user email-address">
                        <label class="input-title-top-container" for="doctor">Doctor</label><br>
                        <input maxlength="20" required class="in-put" type="text" name="doctor" placeholder="&#xf0f0; name" style="font-family:Arial, FontAwesome;"><br>
                    </div>
                    <div class="user user-firstname">
                        <label class="input-title-top-container" for="DateOfPayment">Date of payment</label><br>
                        <input required class="in-put" type="Date" name="DateOfPayment" placeholder="" style="font-family:Arial, FontAwesome;">
                    </div>
                    <div class="user user-lastname">
                        <label class="input-title-top-container" for="ORnumber">Official Receipt Number</label><br>
                        <input maxlength="50" required class="in-put" type="text" name="ORnumber" oninput="validateNumber(this)" placeholder="" style="font-family:Arial, FontAwesome;">
                    </div>
                </div>
                ...
                <div id="drop-area" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)" ondrop="handleDrop(event)">
                    ...
                    <input type="file" id="file-input" name="filename_Upload" multiple onchange="handleFiles(this.files)">
                    <ul id="file-list"></ul>
                </div>
                <div class="user-information">
                    <div class="submit-upload-document">
                        <input id="save-input" name="submit-document" type="submit" value="Submit">
                    </div>
                </div>
            </form>
        </div>
